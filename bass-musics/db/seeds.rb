...
Track.create(name: "Sherane a.k.a. Master Splinter窶冱 Daughter", minutes: 5, album_id: a5.id)
...
Track.create(name: "Sing About Me, I窶冦 Dying of Thirst", minutes: 13, album_id: a5.id)
...
a8 = Album.create(cover: "http://s3.amazonaws.com/codecademy-content/projects/3/bass-music/the-2020-experience.png", title: "asdfsa", artist: "tttt")
Track.create(name: "aaaaaaaaa", minutes: 9, album_id: a8.id)
Track.create(name: "fdsas", minutes: 6, album_id: a8.id)
